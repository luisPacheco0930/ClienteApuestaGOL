<%@ Page Title="" Language="C#" MasterPageFile="~/SWApuestaCliente.Master" AutoEventWireup="true" CodeBehind="PollaSemanalRG.aspx.cs" Inherits="WebApuestasCliente.ResultadoGanadores.PollaSemanalRG" %>
...
<asp:Content ID="contenidoPagina" ContentPlaceHolderID="masterPage" runat="server">
    <div class="page-content">
		<div class="row">
			<div class="col-md-12">
				<h1 class="page-header">Resultados La Polla Semanal</h1>
